...
export default function TrackerPage() {
  ...
  // Prueba gratis: sin rastreador de tiendas, así que Mis testeos siempre estaría vacío —
  // mejor mostrar el bloqueo explícito que una tabla vacía sin explicación.
  if (!canTrackStores) {
    return (
      <PageLayout>
        <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-border bg-card py-24 text-center">
          ...
          <div>
            <p className="text-sm font-semibold text-foreground">Mis testeos se desbloquea con un plan pago</p>
            <p className="mt-1 max-w-sm text-xs text-muted-foreground">
              La prueba gratis no incluye rastreador de tiendas. Suscríbete para empezar a rastrear tus propias tiendas y ver aquí tus candidatos.
            </p>
          </div>
          <Link href="/pricing">
